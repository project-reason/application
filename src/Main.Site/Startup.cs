...
using log4netConfiguration = CrossCutting.Logging.Appenders.Configuration;
...
namespace Main.Site
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddLog4netDBContext(Configuration);
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerfactory, Log4netDBContext context)
        {
